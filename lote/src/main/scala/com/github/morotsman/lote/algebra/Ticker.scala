...
/**
 * A centralized tick source that drives render loops.
 * Components subscribe to receive periodic tick notifications instead of
 * each maintaining their own sleep-based loop.
 */
trait Ticker[F[_]] {
